...
This function uses **constant-time password verification**. When a user is not found, it still runs bcrypt against a dummy hash to prevent timing attacks that could enumerate valid email addresses.
